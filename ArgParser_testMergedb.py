...
def collect_args():
    ...
    parser.add_argument('-G', '--taxon', default=1, help='Specifies the ' + \
             'taxon id to be used to call the Mergedb program.')
    parser.add_argument('-O', '--output1', help='Specifies path to a ' + \
             'file to write messages from running the Mergedb ' + \
             'program. This option is mandatory.')
    return parser
