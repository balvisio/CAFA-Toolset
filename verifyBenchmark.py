...
'''
    ...
    following: 
               t1_iea_handle: file handle for t1_ea file
               t1_exp_handle: file handle for t1_exp file 
               t2_exp_handle: file handle for t2_exp file
               output_filename_LK_bpo: file name for LK-bpo benchmark set
               output_filename_LK_cco: file name for LK-cco benchmark set
               output_filename_LK_mfo: file name for LK-mfo benchmark set

        verify_NK_benchmark: This method need to be invoked to verify 
    NK-benchmark files. The arguments for calling this method are the 
    following: 
               t1_iea_handle: file handle for t1_ea file
               t1_exp_handle: file handle for t1_exp file 
               t2_exp_handle: file handle for t2_exp file
               output_filename_LK_bpo: file name for NK-bpo benchmark set
               output_filename_LK_cco: file name for NK-cco benchmark set
               output_filename_LK_mfo: file name for NK-mfo benchmark set

       The following methods are invoked by the above two methods to create 
    data structure and perform the verification:
       create_iea_dict: This method builds a dictionary for <protein, GO ID> 
...
def verify_LK_benchmark_xxo(t1_iea_dict,
    ...
    # Meaning of xxo: When invoked, xxo need to be replaced by bpo, cco, or mfo to 
...
def verify_NK_benchmark_xxo(t1_iea_dict,
                            ...
                            NKcount):
    # Verify the benchmark entries in the benchmark file: output_filename_NK_xxo
